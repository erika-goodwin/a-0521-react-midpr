            ...
            <div className="w-full lg:w-10/12">
                ...
                <div className="mt-6">
                    <div className="max-w-4xl px-10 py-6 mx-auto bg-white rounded-lg shadow-md">
                        <div className="flex items-center justify-between"><span className="font-light text-gray-600">Jun 1,
                                2020</span><a href="#"
                                className="px-2 py-1 font-bold text-gray-100 bg-gray-600 rounded hover:bg-gray-500">Edit</a>
                        </div>
                        <div className="mt-2"><a href="#" className="text-2xl font-bold text-gray-700 hover:underline">Broken Clouds/1021　hPa</a>
                            <p className="mt-2 text-gray-600">I had a bad headache. Took a pill.</p>
                        </div>
                ...
                <div className="mt-6">
                    <div className="max-w-4xl px-10 py-6 mx-auto bg-white rounded-lg shadow-md">
                        ...
                        <div className="mt-2"><a href="#"
                                className="text-2xl font-bold text-gray-700 hover:underline">Few Clouds/1027 hPa</a>
                            <p className="mt-2 text-gray-600">very light headache. No pill but lot of water.</p>
                        </div>
                ...
                <div className="mt-6">
                    <div className="max-w-4xl px-10 py-6 mx-auto bg-white rounded-lg shadow-md">
                        ...
                        <div className="mt-2"><a href="#" className="text-2xl font-bold text-gray-700 hover:underline">Light Rain/1017 hPa</a>
                            <p className="mt-2 text-gray-600">I needed to skip my class due to headache. Took a pill.</p>
                        </div>
                ...
                <div className="mt-6">
                    <div className="max-w-4xl px-10 py-6 mx-auto bg-white rounded-lg shadow-md">
                        ...
                        <div className="mt-2"><a href="#" className="text-2xl font-bold text-gray-700 hover:underline">Few Clouds/1016 hPa</a>
                            <p className="mt-2 text-gray-600">very light headache. No pill but lot of water.</p>
                        </div>
                ...
                <div className="mt-6">
                    <div className="max-w-4xl px-10 py-6 mx-auto bg-white rounded-lg shadow-md">
                        ...
                        <div className="mt-2"><a href="#" className="text-2xl font-bold text-gray-700 hover:underline">Clear Sky/1011 hPa</a>
                            <p className="mt-2 text-gray-600">I had a bad headache. Took a pill.</p>
                        </div>
